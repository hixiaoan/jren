//
//  SongSquareListController.swift
//  UUEnglish
//
...
class SongSquareListController: RxCollectionController {
    
    var viewModel : MusicCenterViewModel!
...
extension SongSquareListController{
    
    func viewModelCofig() -> SongSquareListController {
        
        viewModel = MusicCenterViewModel(dispose: dispose)
...
extension SongSquareListController {
    @discardableResult
    fileprivate func configUI() -> SongSquareListController {
